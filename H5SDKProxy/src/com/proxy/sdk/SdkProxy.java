...
public class SdkProxy {
	...
	protected void onEnterGame(Map<String, Object> data) {
		...
		//上报游戏数据请求
		HttpService.enterGame(mActivity,sceneId,new BaseListener() {
			@Override
	...
	private  class MyHandler extends Handler{
		...
		public void handleMessage(Message msg) {
			if(msg.what == 0){
				HttpService.doHeartbeat(mActivity,new BaseListener() {
					@Override
					public void onSuccess(Object result) {
						LogUtil.i("send doHeartbeat data is Success!");
					}

					@Override
					public void onFail(Object result) {
						LogUtil.i("send doHeartbeat data is failed!");
				    }
				});
			}
		}
